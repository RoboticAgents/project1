...
| Team Member | Primary Focus Areas | Secondary Responsibilities |
|-------------|--------------------|-----------------------------|
|  |  |  |
|  |  |  |
|  |  |  |

**Note:** We understand that roles may shift based on progress and individual strengths.
...
- [ ] Be on time
- [ ] Come prepared with completed tasks
- [ ] Notify team 24 hours in advance if unable to attend
